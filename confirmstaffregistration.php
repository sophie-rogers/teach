...
/*Starts session and declares session variables for later use*/
  ...
  /*checks if username already exists in database, and if so, JS message prompts user to select a new one.*/

  if (strpos($_SESSION['uniqueUser'], $_POST['newInputName'])){
    ?>
    <script type="text/javascript">
    alert("Username already exists.");
          location="staffregister.php";
</script>
<?php
}

/*assigns post values from registation form to variables using specialchars to prevent injection attacks.
Multiple levels can be selected so this is stored as an array which is then imploded for insertion into table*/

  $levels = implode(",", $_POST["studyLevel"]);
...
/*inserts variables into tutor table within database*/
$sql = "INSERT INTO Tutor (name, fullname, password, dob, address, telNo, email, studyLevels) VALUES ('$newName', '$newFullName', '$newPassword', '$newDOB', '$newAd', '$newTel', '$newEmail', '$newStudyLevel')";
  ...
  <main id="main">
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              ...
              <p>Thanks for registering. Please click below to login.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="sample-page">
      <div class="container" data-aos="fade-up">
        ...
        <a href="stafflogin.php"><input class="submitbuttons" type="button" value="Login" style="
