    ...
    <section class="sample-page">
     ...
     <?php
      ...
      try {
          ...
          /*sql delete query, deleting the entry from the booking table where the ID, date and time match
          the variables set */


               list($cancelID, $cancelDate, $cancelTime) = explode(".", $_POST['action'], 3);
             ...
             (tutorId = '$cancelID' AND onDate = '$cancelDate' AND atTime = '$cancelTime')
               OR (studentId = '$cancelID' AND onDate = '$cancelDate' AND atTime = '$cancelTime') ";
               ...
               echo "Session at ".$cancelTime." on "."$cancelDate". "has been cancelled.";
     ...
     <a href="index.php"><input type="button" onsubmit=""value="Return Home" style="
